      ...
      packages: [
        {
          ...
          departureDate: new Date(2022, 6, 29),
          awb: "28957193295",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 7, 20), 
          awb: "93640145365",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 7, 12), 
          awb: "42345191223",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 8, 20),
          awb: "32657151292", 
        ...
        },
        {
          ...
          departureDate: new Date(2022, 8, 18),
          awb: "12957101114",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 5, 8),
          awb: "72834902536",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 8, 2),
          awb: "28634517893",
        ...
        },
        {
          ...
          departureDate: new Date(2022, 5, 30),
          awb: "46159826371",
            ...
            this.state.packages.map((p, i) => {
              ...
              return (
                <tr key={p.guid}>
                  ...
                  <td>{p.departureDate.toLocaleDateString()}</td>
